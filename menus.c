...
void menuSobre(void) {
	...
	printf("|||                                                                           |||\n");
	printf("|||                 Nomes:     MARCELO VICTOR MELO NUNES                      |||\n");
	printf("|||                            TATIANE ALVES DOS SANTOS                       |||\n");
	printf("|||                                                                           |||\n");
	printf("|||                 Instagram: @marcelovictor_js                              |||\n");
	printf("|||                            @tatialves2                                    |||\n");
	printf("|||                                                                           |||\n");
	printf("|||                 Emails:    marcelo@ufrn.edu.br                            |||\n");
	printf("|||                            santosalvestatiane@gmail.com                   |||\n");
	printf("|||                                                                           |||\n");
	printf("|||                 Github:    github.com/marcelo1403                         |||\n");
	printf("|||                            github.com/tatianealves2                       |||\n");
	printf("|||                                                                           |||\n");
	printf("|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||\n");
	printf("\n");
}
